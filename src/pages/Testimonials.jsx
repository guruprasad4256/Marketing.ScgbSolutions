...
const TestimonialForm = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto my-10 p-8 bg-white border border-slate-200 rounded-[2.5rem] shadow-xl font-[Poppins]">
      ...
      <form onSubmit={handleSubmit} className="space-y-6 text-left">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              {imagePreview ? (
                ...
                <div className="w-11 h-11 rounded-full bg-slate-100 flex items-center justify-center text-slate-400 text-[10px] font-black border border-slate-200">
                  NO IMG
                </div>
              )}
              <div className="relative flex-1 h-[46px]">
                <input
                  ...
                  accept="image/*"
                />
                <div className="absolute inset-0 flex items-center justify-center bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold text-slate-600 hover:bg-slate-100 transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              placeholder="e.g. Reliable digital marketing partner"
              className="w-full bg-slate-50 border border-slate-200 rounded-xl p-3 outline-none focus:ring-2 focus:ring-[#1A4484] font-medium text-sm transition-all"
              required
            />
          </div>
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Paste the full testimonial text here..."
            rows={5}
